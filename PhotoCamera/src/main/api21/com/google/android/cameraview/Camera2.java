...
class Camera2 extends CameraViewImpl {
    ...
    @Override
    void takePicture() {
        Log.e("xp","mAutoFocus=="+mAutoFocus);
        if (mAutoFocus) {
            lockFocus();
        } else {
            captureStillPicture();
            Log.e("xp","captureStillPicture=============");
        }
    }
    ...
    void captureStillPicture() {
        try {
            ...
            // Calculate JPEG orientation.计算图片方向
            ...
            Log.e("xp","图片方向"+(sensorOrientation +mDisplayOrientation * (mFacing == Constants.FACING_FRONT ? 1 : -1) +360) % 360);
